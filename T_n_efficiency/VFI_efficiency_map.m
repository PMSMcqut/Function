...
bata=1.6;%频率系数
L_ref=0.254;%n_ref转速下负载磁链幅值，由有限元算出，为参考点
power_fe=11.18;%对应n_ref和L_ref的铁耗，同样由有限元算出，作为参考点
...
set(ax(1),'Fontsize',16,'ytick',[0:1:10]);
set(ax(2),'Fontsize',16,'ytick',[0:0.4:4]);
cfig = get(gcf,'color');
