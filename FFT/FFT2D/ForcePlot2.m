function []=ForcePlot(F,FourierFr,FourierFt,Time,Space)
load mycolormap;
View.TimeOrder=0:24;
...
VlaueArrayGcf={'3-D waveform of force density','white',[500,100,500,400],'centimeters'};
